...
def api_create_user(request: Request, data: UserIn, db: Annotated[Session, Depends(get_db)]):
...
def api_get_all(request: Request, db: Annotated[Session, Depends(get_db)]):
...
def api_get_one(request: Request, user_id: int, db: Annotated[Session, Depends(get_db)]):
...
def api_update_user(request: Request, user_id: int, data: UserIn, db: Annotated[Session, Depends(get_db)]):
...
def api_delete_user(request: Request, user_id: int, db: Annotated[Session, Depends(get_db)]):
